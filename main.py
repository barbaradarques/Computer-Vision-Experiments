...
# cnn.summary()
# !!! it will start on the 15th layer because I don't have enough RAM for dealing with the earlier layers !!!
layer_names = [layer.name for layer in cnn.layers[15:-1]] # << excludes the first and last layers(input and predictions)
...
for i in range(len(layer_names)):
	o2f.save_data('outputs/' + dataset_name +'/' + dataset_name + '-'+ layer_names[i] +'.txt',
